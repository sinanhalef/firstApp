	...
	return (
		<View style={styles.container}>
			...
			<TouchableOpacity
				...
				onPress={() => { router.push('/id/id_my_sets'); }}
			>
			...
			{selectedSet && (
				<View style={{ flexDirection: 'row', alignItems: 'center' }}>
					<TouchableOpacity
						...
						onPress={() => router.push({ pathname: '/id/id', params: { wordSet: selectedSet } })}
					>
					...
					<TouchableOpacity
						style={[styles.playAndEditButton]}
								onPress={async () => {
									...
									router.push({
										pathname: '/id/id_create_your_own',
										params: {
